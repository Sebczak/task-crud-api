...
public class TrelloFacadeTestSuite {
    ...
    void shouldCreateCard() {
        //Given
        TrelloCard trelloCard = new TrelloCard("card 1", "desc 1", "pos 1", "list id 1");
        TrelloCardDto trelloCardDto = new TrelloCardDto("card 1", "desc 1", "pos 1", "list id 1");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "sample name", "url", new Badges(3, new AttachmentsByType(new Trello(1,1))));
        ...
        assertEquals("sample name", createdTrelloCardDto2.getName());
        assertEquals("url", createdTrelloCardDto2.getShortUrl());
        assertEquals(3, createdTrelloCardDto2.getBadges().getVotes());
    }
